...
if(isset($_REQUEST['btn_update']))
{
    ...
    else
    {
        try
        {
            if(!isset($errorMsg))
            {
                $update_stmt=$db->prepare('UPDATE patient SET nom=:nom, prenom=:prenom, genre=:genre, telephone=:telephone, addresse=:addresse, age=:age, 
                ...
                if($update_stmt->execute())
                {
                    ...
                    header("refresh:3;list.php");  //refresh 3 second and redirect to liste_pat.php page
                }
            }   
        }
        catch(PDOException $e)
...
<div class="wrapper">
    ...
    <div class="container">
        ...
        ?>   
            <h2 style="font-size: 3em;">Modifier</h2>
            ...
            <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                <div class="col-sm-6">
                <input type="text" name="addresse" class="form-control" value="<?php echo $addresse; ?>">
                </div>
                </div>
