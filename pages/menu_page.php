<nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid"  style="background-color: #006666;">
          <a class="navbar-brand" href="#">
            <img src="../image/cr.jpg" style="height: 10vh; width: 100%;" alt="">
          </a>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item" style=" margin-right: 35px; margin-left: 50px; text-align: center;">
                <a class="nav-link" style="color: red; font-size: 20px;width: 200px;" href="ajouter_pat.php">
            ...
            <form class="d-flex">
              ...
              <button class="btn btn-outline-light" style="background-color: #006666;" type="submit">Recherche</button>
            </form>
          </div>
        </div>
      </nav> <br>