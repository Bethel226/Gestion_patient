...
<html lang="fr">
    ...
    <div style="text-align: center;">
      <h4 style="font-family: Algerian; text-align: center;">DETAIL DU PATIENT N° <?= $id ?></h4>
    </div>
<div class="nic_detail d-flex" id='formulaire_bircof' style="background-color: white; margin-left: 20px; margin-right: 20px;">
  <div class="nic_detail2 col-md-4" style="margin: 30px;">
    ...
    <label for="" style="width: 200px;"><strong>Sexe:</strong></label><span> <?= $valuer->getGenre()?> </span>  <br>
    ...
    <label for="" style="width: 200px;"><strong>Groupe Sanguin:</strong></label><span> <?= $valuer->getG_sanguin()?> </span>  <br>
    <label for="" style="width: 200px;"><strong>Maladie:</strong></label><span> <?= $valuer->getM_actuelle()?> </span>  <br>
    <label for="" style="width: 200px;"><strong>Antecedent:</strong></label><span> <?= $valuer->getAntecedant()?> </span>  <br>
  </div>
