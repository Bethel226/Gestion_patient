                                ...
                                <table id="myTable" class="table table-striped table-bordered table-hover" style="background-color: white;">
									...
									?>
                                        <tr>
                                            ...
                                            <td><a href="detail_patient.php?id=<?php echo $row['id']; ?>" class="btn "> <img src="../image/user.jpg"  alt=""> </a></td>
                                            <td><a href="edit.php?update_id=<?php echo $row['id']; ?>" class="btn "> <img src="../image/edit.jpg"  alt=""> </a></td>
                                            <td><a href="?delete_id=<?php echo $row['id']; ?>" class="btn " onclick='return confirm("Etes-vous sûr de vouloir supprimer?")'>  <img src="../image/Close.jpg"  alt=""> </a></td>
                                        </tr>
                                    <?php
									}
									?>
